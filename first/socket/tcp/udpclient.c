...
//
    ...
    sendto(sockfd, send_buf, sizeof(send_buf), 0, (struct sockaddr_in *)&server, &send_len);

    recvfrom(sockfd, recv_buf, sizeof(recv_buf), 0, (struct sockaddr_in *)&client, &recv_len);
